...
def get_args():
    ...
    parser.add_argument("--low_rank", type = str2bool , default=False)
    parser.add_argument("--unit",type=str2bool, default=False)
    ...
    parser.add_argument("--split_mix", type = str2bool, default=False)
    parser.add_argument("--scaler_rate", type=float, default=1)
    parser.add_argument(
        "--arch",
        default="resnet20",
    ...
    parser.add_argument("--need_scaler", default=False, type=str2bool)
    ...
    parser.add_argument("--atom_slim_ratio", default=0.4,type=float)
    ...
    parser.add_argument(
        ...
        type=str,
        default="MultiStepLR",
        choices=["MultiStepLR", "ExponentialLR", "ReduceLROnPlateau", "WarmupCosine"],
    )
    ...
    parser.add_argument("--global_rate", default=1, type=float)
    ...
    parser.add_argument("--softmax_temperature",default=1,type=float)
    parser.add_argument("--class_temperature", default=1, type=float)
    ...
    parser.add_argument("--densenet_bc_mode", default=True, type=str2bool)
    ...
    # device
    parser.add_argument(
        "--python_path", type=str, default="$HOME/conda/envs/pytorch-py3.6.9/bin/python"
    )
